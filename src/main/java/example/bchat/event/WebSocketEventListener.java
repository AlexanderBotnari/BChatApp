package example.bchat.event;

import example.bchat.model.ApplicationStats;
import example.bchat.model.Message;
import example.bchat.utils.Constants;
...
public class WebSocketEventListener {
	...
	public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
		...
		if (username != null) {
			...
			Message message = new Message.Builder(username, Constants.USER_LEFT)
